...
### Nombre de la especialidad **(obligatorio)**

Como se llama en la clínica. Ej.: Ortodoncia y ortopedia maxilar.
...
*Formato:* Lista (una línea por punto)
...
*Formato:* Lista de bloques (Nombre del paso + ¿Qué pasa en este paso?)
...
*Formato:* Selección de lo ya cargado
...
*Formato:* Lista de bloques (Pregunta + Respuesta)
...
### ¿Qué debe decir el botón de esta página?
...
*Formato:* Opción: Reservar cita / Consultar sobre mi caso / Solicitar evaluación
...
Sin el Dr. o Dra. delante: eso lo pone la web sola.
...
Ej.: Directora médica, Especialista en endodoncia, Cirujano dentista.
...
### Número de COP **(obligatorio)**

Colegio Odontológico del Perú. Solo el número.
...
*Formato:* Opción: Vigente / En trámite
...
Se usa en el contador de la portada.
...
Marca el punto de interés sobre el rostro para que el recorte no lo corte.
...
Aparece primero en Equipo y destacada en la portada.
...
### Nombre del equipo o técnica **(obligatorio)**

Ej.: Escáner intraoral 3D. Flujo digital de trabajo.
...
Explicación breve. Qué hace el equipo.
...
Los pasos concretos. Es el contenido que más se consulta de esta página.
...
### ¿Cómo se coordina el caso?

Quién habla con quién, en qué momento y por qué vía.
...
Si el paciente vuelve al colega derivante, decirlo aquí y explícitamente.
...
Solo se muestra si las mentorías están activadas.
...
### Correo para recibir radiografías
