  ...
  enlacesDoctocliq: [
    {
      ...
      url: "https://wa.me/51985996818?text=Hola%20Arieta%20Noova,%20deseo%20agendar%20mi%20Evaluaci%C3%B3n%20de%20S/%2060",
    },
    {
      _key: "doc2",
      etiqueta: "Consulta Dra. Jessica Arieta",
      url: "https://wa.me/51985996818?text=Hola%20Arieta%20Noova,%20deseo%20agendar%20una%20consulta%20con%20la%20Dra.%20Jessica%20Arieta",
    },
  ],
  redes: [
...
export const EQUIPO_RESPALDO: MiembroEquipo[] = [
  ...
  {
    _id: "dra-karen-ventura",
    nombre: "Dra. Karen Julissa Ventura Asencios",
    slug: "dra-karen-ventura",
    cargo: "Especialista en Rehabilitación Oral",
    ...
    formacion: [
      ...
      "Experta en estética dental, carillas cerámicas y oclusión",
    ],
    bio: "Especialista en rehabilitación integral, estética dental de alta precisión y oclusión funcional.",
  ...
  },
  {
    ...
    formacion: [
      ...
      "Manejo de instrumentación mecanizada rotatoria sin dolor",
    ],
    bio: "Cirujano dentista dedicado a la Endodoncia y conservación de piezas dentales complejas.",
    fotoLocal: "/imagenes/dr-diego-belsuzarri.jpg",
    orden: 3,
  },
  {
    _id: "dr-luis-maldonado",
    nombre: "Dr. Luis Alberto Maldonado Huamani",
    slug: "dr-luis-maldonado",
    cargo: "Cirujano Dentista – Implantología",
    ...
    bio: "Dedicado a la implantología dental osteointegrada y procedimientos quirúrgicos avanzados.",
    orden: 4,
  },
  {
    _id: "dra-zenaida-rojas",
    nombre: "Dra. Zenaida Rojas Apaza",
    slug: "dra-zenaida-rojas",
    ...
    formacion: [
      ...
      "Manejo conductual pediátrico y prevención integral",
    ],
    bio: "Especialista en la atención odontológica cálida y preventiva para niños y adolescentes.",
    fotoLocal: "/imagenes/dra-odontopediatria.jpg",
    orden: 5,
  },
  {
    _id: "dr-fernando-montesinos",
    nombre: "Dr. Fernando Duani Montesinos Estaño",
    slug: "dr-fernando-montesinos",
    cargo: "Especialista en Cirugía Máxilo Facial",
    ...
    formacion: [
      "Cirujano Dentista",
      "Especialista en Cirugía Máxilo Facial (RNE 1667)",
      "Cirugía ortognática y patología bucomaxilofacial",
    ],
    bio: "Especialista en cirugía reconstructiva, extracción de terceras molares complejas y armonización maxilofacial.",
    orden: 6,
  },
  {
    _id: "dr-ronald-caceres",
    nombre: "Dr. Ronald Walter Cáceres Villarreal",
    slug: "dr-ronald-caceres",
    cargo: "Cirujano Dentista – Endodoncia",
    especialidad: "Endodoncia",
    colegiatura: "24837",
    rneEstado: "en-tramite",
    formacion: [
      "Cirujano Dentista",
      "Entrenamiento avanzado en Endodoncia clínica y retratamientos",
    ],
    bio: "Cirujano dentista dedicado al alivio del dolor agudo y salvamento de piezas dentales mediante endodoncia.",
    orden: 7,
  },
];
