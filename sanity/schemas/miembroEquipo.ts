...
export const miembroEquipo = defineType({
  ...
  fields: [
    ...
    defineField({
      name: "anioTitulacion",
      title: "Año de titulación como cirujano dentista",
      type: "number",
      group: "credenciales",
      description: "Ej.: 2001. Marca el inicio del ejercicio profesional.",
      validation: (r) => r.min(1950).max(2100),
    }),
    defineField({
      name: "aniosEjercicio",
      title: "Años de ejercicio profesional",
      type: "number",
      group: "credenciales",
      description: "Ej.: 25 años. Años totales de ejercicio como odontólogo/a.",
      validation: (r) => r.min(0).max(70),
    }),
    defineField({
      name: "anioEspecialidad",
      title: "Año de obtención de la especialidad",
      type: "number",
      group: "credenciales",
      description: "Ej.: 2013 (opcional).",
      validation: (r) => r.min(1950).max(2100),
    }),
    defineField({
      name: "aniosComoEspecialista",
      title: "Años como especialista",
      type: "number",
      group: "credenciales",
      description: "Ej.: 13 años (opcional). Se muestra siempre con la etiqueta explícita de especialista.",
      validation: (r) => r.min(0).max(70),
    }),
    defineField({
      name: "docencia",
      title: "Cátedra y docencia universitaria",
      type: "array",
      group: "credenciales",
      description: "Universidades e instituciones donde ha ejercido la docencia.",
      of: [
        {
          type: "object",
          ...
          fields: [
            defineField({
              name: "institucion",
              title: "Universidad o Institución",
              type: "string",
              validation: (r) => r.required(),
            }),
            defineField({
              name: "aniosDocencia",
              title: "Años de docencia o período",
              type: "string",
              description: "Ej.: Más de 10 años, o 4 años.",
              validation: (r) => r.required(),
            }),
            defineField({
              name: "vigente",
              title: "¿Docencia vigente?",
              type: "boolean",
              initialValue: true,
            }),
          ],
          preview: {
            select: { title: "institucion", subtitle: "aniosDocencia" },
          },
        },
      ],
    }),
