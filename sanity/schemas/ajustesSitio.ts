...
export const ajustesSitio = defineType({
  ...
  fields: [
    defineField({
      ...
      type: "string",
      group: "identidad",
      description: "Debe coincidir letra por letra con INDECOPI y la ficha de Google Business.",
      initialValue: "ArietaNoova",
    ...
    defineField({
      ...
      description: "Logo para cabecera sobre fondo blanco o crema. Formato preferente: SVG vectorial.",
    }),
    defineField({
      name: "logoInvertido",
      title: "Logo invertido (fondo oscuro)",
      type: "image",
      group: "identidad",
      options: { accept: ".svg,.png,.webp" },
      description: "Logo para usar sobre fondos oscuros o de pie. Formato preferente: SVG vectorial.",
    }),
    defineField({
      name: "isotipo",
      ...
      group: "identidad",
      options: { accept: ".svg,.png,.webp" },
      description: "Símbolo de la marca para avatares, favicon e imágenes de Open Graph.",
    }),
    defineField({
      name: "favicon",
      title: "Favicon",
      type: "image",
      group: "identidad",
      options: { accept: ".png,.svg,.ico" },
      description: "Ícono de pestaña del navegador.",
    }),
    defineField({
      name: "direccion",
      title: "Dirección",
